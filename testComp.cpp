...
TEST_CASE("twoDtree::basic ctor render","[weight=1][part=twoDtree]"){
    ...
    PNG out = t1.render();
    out.writeToFile("images/ada_ouput.png");
...
TEST_CASE("twoDtree::basic prune","[weight=1][part=twoDtree]"){
    ...
    result.writeToFile("images/ada_ouputprune.png");
...
TEST_CASE("twoDtree::small idealPrune","[weight=1][part=twoDtree]"){
    PNG img;
    img.readFromFile("images/geo.png");
    
    twoDtree t1(img); 
    cout << "calling ideal prune" << endl;
    int result = t1.idealPrune(10);
